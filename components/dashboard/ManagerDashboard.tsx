...
const ITEMS = [
  ...
  { key: "slaWarnings", label: "SLA под угрозой", href: "/tasks", tone: "text-yellow-300" },
  { key: "overdueOperationalTasks", label: "Просроченные задачи", href: "/tasks", tone: "text-red-300" },
...
export default function ManagerDashboard() {
  ...
  const values: Record<(typeof ITEMS)[number]["key"], number> = {
    ...
    slaWarnings: data?.slaWarningsCount ?? 0,
    overdueOperationalTasks: data?.overdueOperationalTasksCount ?? 0,
