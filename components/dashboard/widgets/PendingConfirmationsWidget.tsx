...
export default function PendingConfirmationsWidget() {
  ...
  return (
    <Link
      ...
      className="flex h-full flex-col rounded-3xl border border-amber-400/30 bg-amber-500/10 p-6 transition hover:bg-amber-500/15"
    >
      ...
      <span className="mt-auto self-start rounded-xl border border-amber-300/40 px-3 py-2 text-sm text-amber-100">Открыть</span>
    </Link>
  );
}
