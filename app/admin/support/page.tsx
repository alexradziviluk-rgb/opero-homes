...
type Ticket = { public_number: string; requester_name: string | null; category: string; priority: string; status: string; conversation_state?: string; subject: string; delivery_status: string; apartment_id?: string | null; booking_id?: string | null; ai?: { intent?: string; action?: string } | null; created_at: string };
