...
export default function ClientForm({ value, errors, onChange }: ClientFormProps) {
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <label>
        ...
        <input type="date" value={value.dateOfBirth} onChange={(event) => onChange("dateOfBirth", event.target.value)} className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none" />
      </label>
