-- Final production-schema corrections found by post-apply lint and ACL audit.
...
begin
  ...
  on conflict (organization_id, user_id) do update
    set role_code = 'owner', status = 'active';
...
revoke all on table public.apartment_photos, public.support_messages, public.reviews, public.support_anonymous_rate_limits, public.support_telegram_updates from public, anon;
